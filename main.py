...
api_id = 121611
api_hash = 'f11d453c25e07f904821dcfac6a697dd'
...
class ChatWarsAutomator(object):
    def __init__(self, client, config):
        ...
        self.STOCKBOT_PROPS   = self.find_props('enotobot')
        ...
        self.STOCKBOT_ID = self.find_props_id('enotobot')
        ...
        self.stockbot_dialog  = self.find_dialog_user('enotobot')
